...
public class OutroVideoPlayer : MonoBehaviour
{
    ...
    [Tooltip("The VideoPlayer component playing the outro video. If null, will try to find one on this GameObject.")]
    public VideoPlayer videoPlayer;

    [Header("Scene Transition Settings")]
    [Tooltip("The name of the scene to load after the video finishes (e.g., 'MainMenu').")]
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("OutroVideoPlayer: No VideoPlayer component found! Loading next scene immediately.", this);
            LoadNextScene();
        }
    }
    ...
    private void LoadNextScene()
    {
        ...
        Debug.Log("Outro video ended/skipped. Loading scene: " + nextSceneName);
